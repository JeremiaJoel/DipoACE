                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-1 gap-6">
                    <div class="bg-white shadow rounded-lg p-4">
                        <div class="grid grid-cols-4 items-center">
                                <!-- Grup Status Verifikasi -->
                                <div class="col-span-3">
                                    <div class="text-center mb-4">
                                        <p class="text-gray-600 font-semibold">Status Verifikasi IRS Mahasiswa</p>
                                    </div>
                                    <div class="grid grid-cols-2 gap-4 text-center cursor-pointer">
                                        <div class="bg-white shadow rounded-lg p-4 h-20 hover:bg-blue-700 hover:text-white"
                                            onclick="window.location.href='{{ route('tabelVerifikasiIRS') }}'">
                                ...
                                <div class="flex items-center justify-center cursor-pointer">
                                    <div class="bg-white shadow rounded-lg p-4 h-20 w-full hover:bg-blue-700 hover:text-white"
                                        onclick="window.location.href='{{ route('nyusunJadwalKaprodi') }}'">
                                        <h2 class="text-xl font-semibold text-center">Buat Jadwal</h2>
                                    </div>
                                </div>
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
                        <div
                        ...
                        <div class="bg-white shadow rounded-lg p-4 h-20 hover:bg-blue-700 hover:text-white cursor-pointer">
