    ...
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-center mt-4">
            <div class="bg-slate-400 p-4 rounded-lg shadow-md flex items-center space-x-4">
             <img alt="Profile Picture" class="h-32 w-24 rounded-lg" height="100" src="../img/icong.jpg" width="100"/>
             <div>
           ...
           <div class="flex justify-center mt-8 space-x-8">
                <div class="bg-white p-4 rounded-lg shadow-md flex flex-col items-center space-y-2">
