                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="flex items-baseline space-x-4">
                                <a class="rounded-md px-3 py-2 text-2xl font-medium text-white" href="{{ url('/dashboard-mahasiswa') }}">DipoACE</a>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div x-data="{ isOpen: false }"
                                            ...
                                            <div class="text-gray-500">Jumlah SKS
                                                {{ \App\Models\khs::where('nim', $nim)->sum('sks') }}
                                            ...
                                            <div x-show="isOpen"
                                                        ...
                                                        @else
                                                            @foreach ($khsData as $index => $khs)
                                                                <tr>
                                                                    ...
                                                                    <td class="border px-4 py-2">{{ $khs->matakuliah }}
                                                                    </td>
                                                                    <td class="border px-4 py-2">{{ $khs->jenis }}
                                                                    </td>
                                                                    <td class="border px-4 py-2">{{ $khs->status_mk }}
                                                                    </td>
                                                                    <td class="border px-4 py-2">{{ $khs->sks }}
                                                                    </td>
                                                                    <td class="border px-4 py-2">
                                                                        {{ $khs->nilai_huruf }}</td>
                                                                    <td class="border px-4 py-2">{{ $khs->bobot }}
                                                                    </td>
                                                                    <td class="border px-4 py-2">
                                                                        {{ $khs->sks_x_bobot }}</td>
                                                                </tr>
                                                            ...
                                                            @php
                                                                ...
                                                                $sks_x_bobot = \App\Models\khs::where('nim', $nim)->sum('sks_x_bobot');
                                                                $ipsemester = $sks > 0 ? $sks_x_bobot / $sks : 0;
                                                            @endphp
                                                            <tr>
                                                                <td colspan="5" class="border px-4 py-2 text-left">Total</td>
                                                                <td class="border px-4 py-2">{{  $sks }}</td>
                                                                <td class="border px-4 py-2"></td>
                                                                <td class="border px-4 py-2">{{ $bobot }}</td>
                                                                <td class="border px-4 py-2">{{ $sks_x_bobot }}</td>
                                                            </tr>
                                                        @endif
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mt-4">IP. Semester: {{ number_format($ipsemester, 2) }}</p>
                                                    <p class="text-sm md:text-base">{{ $sks_x_bobot }}/{{ $sks }}</p>
