                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="h-8 w-8" src="../img/undip.png" alt="Logo Undip">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            <span class="rounded-md px-1 py-2 text-xl font-medium text-white">Nama aktor dosen</span>
                ...
                <div class="bg-white shadow rounded-lg overflow-hidden">
                    <div class="bg-gray-800 p-4 flex items-center">
                        ...
                        <div class="ml-4 text-white">
                            <h1 class="text-2xl font-bold">Nama Dosen</h1>
                            <p class="mt-1">NIP: 24060122120001 | Informatika S1</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white shadow rounded-lg p-4">
                        ...
                        <div class="mt-4 grid grid-cols-3 gap-4 text-center cursor-pointer">
                            <div class="bg-white shadow rounded-lg p-4 h-20 hover:bg-blue-700 hover:text-white"
                                onclick="window.location.href='{{ route('tabelMahasiswa') }}'">
